...
public class ClassicLudoRedPP : ClassicLudoPP
{
    ClassicLudoRD redHomeRollingDice;
    ...
    void Start()
    {
        ...
        redHomeRollingDice = GetComponentInParent<ClassicLudoRed>().rollingdice;
    }

    public void OnMouseDown()
    {
        if (ClassicLudoGM.game.rolingDice == ClassicLudoGM.game.manageRolingDice[1])
        {
            ...
            else if (!isready && ClassicLudoGM.game.rolingDice == redHomeRollingDice)
            {
